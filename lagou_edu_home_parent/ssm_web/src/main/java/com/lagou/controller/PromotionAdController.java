...
public class PromotionAdController {
    ...
    public ResponseResult findAllPromotionAdMapperByPage(PromotionAdVO promotionAdVO){
        PageInfo<PromotionAd> pageInfo = promotionAdService.findAllPromotionAdMapperByPage(promotionAdVO);
  ...
  */
    ...
    public ResponseResult saveOrUpdatePromotionAd(@RequestBody PromotionAd promotionAd){
     ...
     public ResponseResult findPromotionAdById(Integer id){
         ...
         ResponseResult responseResult = new ResponseResult(true, 200, "回显广告名称成功", ad);
